...
class ScheduleModel
{
    ...
    function create($data)
    {
        ...
        $qry = "insert into schedules (`company_id`,`client_id`,`job_id`,`start`,`end`,`employee_cnt`,`workday_id`) values (?,?,?,?,?,?,?);";
        $values = [$this->CompanyId, $clientId, $jobId, $start, $end, $employeeCnt,$workdaysId];
